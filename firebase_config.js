...
const i18n = {
  ko: {
    ...
    "main_admin_title_master": "👑 최고 관리자 메뉴", "main_admin_title_manager": "🛡️ 운영진 전용 메뉴",
    "main_admin_desc": "관리자 및 운영진에게만 보이는 특수 메뉴입니다.",
    "main_card_admin": "인원 승인 및 권한 관리", "main_card_admin_desc": "새로 가입한 대기자를 승인하거나 길드원의 직책을 설정합니다.",

    // 주간 결산 페이지 (weekly.html) - 기존 유지
    ...
    // 출석부 페이지 (attendance.html)
    "att_title": "📅 활동 캘린더 (리셋: UTC 00시)",
    "att_desc": "'출석하기' 버튼을 눌러 점수를 입력하세요. (과거 출석 시 50% 패널티)",
    "att_modal_title": "활동 기록",
    "att_warning": "⚠️ 과거 날짜입니다.<br>입력하신 점수의 50%만 반영됩니다.",
    "att_laby": "⚔️ 이계 점수", "att_duel": "🛡️ 명결 점수", "att_activity": "🔥 길드 활약도 점수",
    "att_btn_cancel": "취소", "att_btn_save": "기록 저장",
    "att_btn_past": "👆 과거 출석", "att_btn_today": "👆 출석하기", "att_btn_done": "✅ 출석완료"
  },
  en: {
    ...
    "main_desc": "Please select a task you want to do.",
    ...
    "main_admin_title_master": "👑 Guild Master Menu", "main_admin_title_manager": "🛡️ Manager Menu",
    "main_admin_desc": "Special menu visible only to Master and Managers.",
...
function applyLanguage() {
  document.querySelectorAll("[data-i18n]").forEach(el => {
    ...
    if (i18n[currentLang] && i18n[currentLang][key]) {
      el.innerHTML = i18n[currentLang][key]; // innerHTML로 변경하여 <br> 태그 등 작동 보장
    }
  });
...
function toggleLanguage() {
  ...
  location.reload(); // 💡 달력 버튼 등 자바스크립트가 그린 요소를 완벽하게 새로고침하기 위해 reload 적용
}
